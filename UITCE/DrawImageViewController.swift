...
class DrawImageViewController: UIViewController
{
    ...
    fileprivate func setupToolBar() {
        ...
        toolBar.undoButton?.addTarget(self, action: #selector(DrawImageViewController.onClickUndoButton), for: .touchUpInside)
        toolBar.redoButton?.addTarget(self, action: #selector(DrawImageViewController.onClickRedoButton), for: .touchUpInside)
...
// MARK: - CanvasDelegate
extension DrawImageViewController: CanvasDelegate
{
    func brush() -> Brush? {
...
extension DrawImageViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate
{
...
extension DrawImageViewController: RSKImageCropViewControllerDelegate
{
...
extension DrawImageViewController: UIActionSheetDelegate
{
...
extension DrawImageViewController: UIAlertViewDelegate
{
...
extension DrawImageViewController: PaletteDelegate
{
